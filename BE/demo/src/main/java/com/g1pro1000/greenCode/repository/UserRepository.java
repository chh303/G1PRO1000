...
import com.g1pro1000.greenCode.model.User; // Importerer User-modellen som representerer en rad i databasen
import java.util.Optional; // Importerer Optional for å håndtere potensielt tomme databaseforespørsler
